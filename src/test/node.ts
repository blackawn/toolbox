...
namespace EsLint {
  export interface tsssss {}

  export type xxxxxxx = {}


const x: EsLint.tsssss = {
...
export type _Evaluate<
  ...
  OperatorStack extends EsLint.tsssss = [],
  ...
  ? Ch extends Integer.Digit
    ...
    : Ch extends Operators
      ? OperatorStack extends [infer Op, ...infer OperatorStackRest]
        ? _IsGreaterOrEqualPrecedence<Op extends string ? Op : '', Ch> extends true
...
type _ApplyOpFromStack<Op, Expr extends string, OutputStack, OperatorStack> = OutputStack extends [
  infer B,
  infer A,
  ...infer OutputStackRest
]
  ? _Evaluate<
      Expr,
      [
...
type _IsGreaterOrEqualPrecedence<A extends string, B extends string> = A extends Operators
  ? B extends Operators
...
type _ApplyOp<Op extends Operators, A extends string, B extends string> = A extends Integer.Number
